import header_cases from 'assets/img/cases_1.png'
        ...
        <div className="mx-auto max-w-full xl:mx-12 xl:pt-40 xl:pb-64 lg:pt-40 lg:pb-48 pt-24 pb-12  ">
          <div>
            <div>
              ...
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo <span className='lg:text-xl text-md font-medium leading-8 text-gray-700 sm:text-center  transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-button'><Link to='/'> Web Development</Link></span> 
            ...
            <div className="absolute inset-x-0 top-[calc(100%-20rem)] -z-10 transform-gpu overflow-hidden bg-white blur-lg lg:top-[calc(100%-45rem)] sm:top-[calc(100%-30rem)]">
              <img src={header_cases} className='w-full h-full object-cover opacity-50 blur-2'/>
