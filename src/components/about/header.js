...
function Header(){
    ...
    return(
      <main>
      <div className="relative px-12 lg:px-12 py-11">
        <div className="mx-auto max-w-full xl:mx-12 xl:pt-40 xl:pb-64 lg:pt-40 lg:pb-48 pt-32 pb-20">
          <div>
            <div>
              <h1 className="text-4xl font-semibold tracking-tight pb-10 sm:text-4xl">
              ¿Quienes somos?
              </h1>
              <p className="mt-5 text-2xl max-w-3xl leading-8 text-black ">
              ...
              <div className="absolute bottom-0 left-0 flex space-x-6 xl:mx-20 mx-20">
